...
local v2 = {
    LoaderData = {
        ...
        Colors = shared.LoaderColors or {
            ...
            Topic = Color3.fromRGB(0, 200, 255),
            Title = Color3.fromRGB(0, 200, 255),
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://72714062799260",
...
function CheckLevel()
    ...
    if Sea3 then
        ...
        elseif ((v197 == 2575) or (v197 <= 2599) or (SelectMonster == "Skull Slayer") or (v197 == 2600)) then
          ...
          elseif ((v197 == 2600) or (v197 <= 2624) or (SelectMonster == "Reef Bandits" or (v197 == 2625)) then
          Ms = "Reef Bandits";
          NameQuest = "SubmergedQuest1";
           CFrameQ = CFrame.new(10785.5762, -2087.75366, 9257.24707);
           CFrameMon = CFrame.new(10655.8125, -2068.40967, 9484.5791);
        end
    end
end
if Sea1 then
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=72714062799260";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/m7CKwVTC");
    end
    });
    v16.Home:AddButton({
    Title = "ShiftLock",
    Description = "",
    Callback = function()
        loadstring(game:HttpGet("https://rawscripts.net/raw/Universal-Script-ShiftLock-Universal-Script-51730"))()
    end
});
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://72714062799260") then
                    return v729;
                end
            end
        end
...
v16.Teleport:AddButton({
    ...
    Callback = function()
        ...
        elseif (_G.SelectIsland == "Underwater Submerged Island") then
            Tween2(CFrame.new(- 10785.5762, -2087.75366, 9257.24707));
        end
    end
});
v16.Teleport:AddButton({
